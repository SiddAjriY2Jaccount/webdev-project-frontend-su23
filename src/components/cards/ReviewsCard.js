...
const ControlButton = styled.button`
  ${tw`mx-3 p-4 rounded-full transition duration-300 bg-gray-200 hover:bg-gray-300 text-pink-700 hover:text-pink-900 focus:outline-none focus:shadow-outline`}
  svg {
    ${tw`w-4 h-4 stroke-3`}
  }
`;
...
const Input = tw.input`w-full mt-8 first:mt-0 border-b-2 py-3 focus:outline-none font-medium transition duration-300 hocus:border-pink-700`
const Range = tw.input`w-full mt-6 first:mt-6 border-b-2 py-3 focus:outline-none font-medium transition duration-300 hocus:border-pink-700`
...
const Textarea = styled(Input).attrs({ as: "textarea" })`
  ${tw`h-24`}
`
const Label = tw.label`mt-6 first:mt-6 py-6 focus:outline-none text-lg font-medium transition duration-300 hocus:border-pink-200 text-start`
